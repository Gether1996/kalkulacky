...
class FreelancerTaxCalculator(BaseCalculator):
    ...
    SOCIAL_SICKNESS_RATE = cfg.FREELANCER_SOCIAL_SICKNESS_RATE  # 4.4% - sickness (voluntary)
    SOCIAL_PENSION_RATE = cfg.FREELANCER_SOCIAL_PENSION_RATE  # 18%
    SOCIAL_DISABILITY_RATE = cfg.FREELANCER_SOCIAL_DISABILITY_RATE  # 6%
    SOCIAL_ACCIDENT_RATE = cfg.FREELANCER_SOCIAL_ACCIDENT_RATE  # 0% - SZČO neplatia úrazové
    SOCIAL_GUARANTEE_RATE = cfg.FREELANCER_SOCIAL_GUARANTEE_RATE  # 0% - SZČO neplatia garančné
    ...
    NON_TAXABLE_AMOUNT_ANNUAL = cfg.FREELANCER_NON_TAXABLE_AMOUNT_ANNUAL  # €5,966.76/year (2026)
